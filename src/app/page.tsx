            ...
            <div className="grid w-full grid-cols-1 items-center gap-8 lg:grid-cols-2 lg:gap-12">
              <div className="w-full space-y-6 text-white">
                ...
                <p className="max-w-xl text-xl text-white">
                  Helping retail brands, D2C companies, and franchise businesses
                  create impactful brand experiences that improve customer
              ...
              {[
                {
                  ...
                  desc: "Strategies that make customers choose your brand.",
                },
                {
                  icon: <Lightbulb />,
                  title: "In-Shop Branding",
                  desc: "Brand experiences from wall graphics to display units.",
                },
                {
                  icon: <PanelsTopLeft />,
                  title: "Store Layout & Space Design",
                  desc: "Layouts designed to improve customer flow and increase conversions.",
                },
                {
                  icon: <Signpost />,
                  title: "Navigation & Wayfinding Signages",
                  desc: "Signages that guide customer movement and decisions.",
                },
                {
                  icon: <ShoppingBag />,
      ...
      {[
        ...
        >
          <div className="container relative z-10 mx-auto max-w-7xl space-y-8 px-4 text-center">
            ...
            <p>
              The right marketing partner can help you grow faster.
            </p>
